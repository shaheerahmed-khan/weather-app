...
export default function WeatherBoard({ currentWeatherData, dailyWeatherData }) {
  return (
    <div className="flex flex-col gap-4 w-full">
      ...
      <AdditionalWeatherMetrics currentWeatherData={currentWeatherData} />
      <DailyForecast dailyWeatherData={dailyWeatherData} />
    </div>
  );
}
